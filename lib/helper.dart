            ...
            children: challenges.map((challenge) {
              return ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    Text('Progress: ${challenge.currentVal}/${challenge.goal}'),
...
void showSettingsDialog(BuildContext context, ThemeNotifier themeNotifier) async {
  final prefs = await SharedPreferences.getInstance();
  bool isHapticEnabled = prefs.getBool('isHapticEnabled') ?? true;
  // Set the default language index: 0 for English, 1 for Arabic.
  int selectedLangIndex = Localizations.localeOf(context).languageCode == 'ar' ? 1 : 0;
                        ...
                        children: [
                          ...
                          DropdownButton<int>(
                            ...
                            items: const [
                              ...
                              DropdownMenuItem(value: 1, child: Text('العربية')),
                            ],
                            onChanged: (value) {
                              setState(() {
...
Widget longBuildModeButton(BuildContext context, String text, Color gradStart,
...
Widget buildModeButton(BuildContext context, String text, Color gradStart,
    Color gradEnd, VoidCallback onPressed) {
  double scale = 1.0;
          ...
          child: Container(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                text,
                style: TextStyle(
                  fontSize: Localizations.localeOf(context).languageCode == 'ar' ? 19 : 15,
                  color: Colors.white,
                ),
              ),
            ),
...
Widget smallButton(BuildContext context, Icon icon, Color gradStart,
    Color gradEnd, VoidCallback onPressed) {
  double scale = 1.0;
